...
# Add daemon/src to sys.path to allow importing internal modules correctly
# We add it as a package root
sys.path.append(os.getcwd())

# We need to import things using the daemon.src prefix
...
async def run_audit():
    ...
    logger.info(f"      To connect, run in a NEW terminal: python daemon/src/mirror_bridge.py {port}")
    ...
    try:
        while True:
            ...
            # Allow some time for the echo back
